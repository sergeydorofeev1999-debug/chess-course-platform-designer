...
export default function KnightPawnBoard({ onComplete, lessonId, lessonTitle }: { onComplete: () => void; lessonId?: string; lessonTitle?: string }) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full select-none" >
      ...
      <div className="text-center text-sm text-[#6B5B3D] max-w-sm px-4">
        ...
        <p className="text-xs text-[#B8AFA3] mt-1">Конь ходит буквой Г: на 2 поля по прямой и на 1 поле вбок.</p>
      </div>

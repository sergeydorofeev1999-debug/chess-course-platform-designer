...
export default function BishopPawnBoard({ onComplete, lessonId, lessonTitle }: { onComplete: () => void; lessonId?: string; lessonTitle?: string }) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full select-none">
      ...
      <div className="flex items-center gap-2 w-full max-w-sm px-2">
        <button
          onClick={() => alert('Подсказка: используй слона для дальних ударов и пешки для продвижения.')}

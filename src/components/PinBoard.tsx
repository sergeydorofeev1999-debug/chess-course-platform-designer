...
const HINTS: Record<number, { from: string; to: string; phase: 0 | 1 }[]> = {
  1: [{ from: 'd2', to: 'e2', phase: 0 }, { from: 'e2', to: 'e5', phase: 1 }],
  2: [{ from: 'a4', to: 'f4', phase: 0 }, { from: 'f4', to: 'e5', phase: 1 }],
  3: [{ from: 'f1', to: 'c4', phase: 0 }, { from: 'c4', to: 'd5', phase: 1 }],
  4: [{ from: 'f2', to: 'f4', phase: 0 }, { from: 'f4', to: 'e5', phase: 1 }],
